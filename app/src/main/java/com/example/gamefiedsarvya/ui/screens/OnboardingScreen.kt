        ...
        LearningTier.values().forEach { tier ->
            ...
            Box(modifier = Modifier
                ...
                Row(verticalAlignment = Alignment.CenterVertically) {
                    ...
                    if (isSelected) Text("OK", style = MaterialTheme.typography.titleLarge.copy(color = color))
                }
            }
        }
    ...
    Column(
        ...
        DifficultyPreference.values().forEach { diff ->
            ...
            Row(modifier = Modifier
                ...
                if (isSelected) Text("OK", style = MaterialTheme.typography.titleLarge.copy(color = NeonOrange))
            }
        }
